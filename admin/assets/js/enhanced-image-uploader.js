...
class EnhancedImageUploader {
    constructor(editorElement, contentInput, options = {}) {
        ...
        this.options = {
            ...
            uploadUrl: '/admin/modules/content/upload.php',
            ...options
        };
        this.uploadedImages = [];
        ...
        window.layer.open({
            ...
            content: `
                <div style="padding: 20px;">
                    <!-- 上传模式切换 -->
                    <div style="margin-bottom: 20px; padding: 15px; background-color: #f7f7f7; border-radius: 8px;">
                        <div style="display: flex; align-items: center;">
                            <label style="font-weight: 500; margin-right: 15px; color: #333;">上传模式：</label>
                            <select id="upload-mode-select" class="layui-select" style="width: 150px; height: 36px; border-radius: 4px; border: 1px solid #dcdcdc;">
                    ...
                    ">
                        <i class="layui-icon layui-icon-upload" style="font-size: 50px; color: #1E9FFF; margin-bottom: 15px;"></i>
                        <div id="upload-mode-text" style="font-size: 16px; color: #333; margin-bottom: 8px; font-weight: 500;">点击上传图片，或将图片拖拽到此处</div>
                        <div class="layui-word-aux" style="color: #999; font-size: 13px;">支持 JPG, PNG, GIF, WebP, BMP, TIFF 格式</div>
                    </div>
                    ...
                    <!-- 上传进度条 - 美化设计 -->
                    <div id="imageUploadProgress" style="display: none; margin-bottom: 20px; padding: 15px; background-color: #fff; border-radius: 8px; border: 1px solid #e6e6e6;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="color: #666; font-size: 14px;">上传中...</span>
                            <span id="upload-progress-text" style="color: #1E9FFF; font-size: 14px; font-weight: 500;">0%</span>
                        </div>
                    ...
                    <div id="imagePreviewContainer" style="display: none; margin-bottom: 20px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            <h4 style="margin: 0; font-size: 16px; font-weight: 500; color: #333;">
                                <i class="layui-icon layui-icon-picture" style="color: #1E9FFF; margin-right: 8px;"></i>
                                已上传图片
                            </h4>
                            <span id="image-count" style="color: #666; font-size: 13px;">0张</span>
                        </div>
                    ...
                    <!-- 按钮区域 - 美化设计 -->
                    <div style="text-align: center; padding-top: 15px; border-top: 1px solid #e6e6e6;">
    ...
    addImagePreview(file, imageUrl, previewList, previewContainer, insertBtn) {
        ...
        previewItem.style.boxShadow = '0 2px 8px rgba(0, 0, 0, 0.08)';
        ...
        previewItem.addEventListener('mouseenter', () => {
            ...
            previewItem.style.transform = 'translateY(-4px)';
            previewItem.style.boxShadow = '0 4px 16px rgba(0, 0, 0, 0.12)';
        });
        ...
        deleteBtn.style.boxShadow = '0 2px 6px rgba(0, 0, 0, 0.15)';
        ...
        fileName.style.padding = '6px 8px';
     ...
     */
    insertImages() {
        if (!this.editor || this.uploadedImages.length === 0) return;
        ...
        this.uploadedImages.forEach((imageUrl, index) => {
            ...
            const finalHtml = this.uploadMode === 'multiple' && index < this.uploadedImages.length - 1 ? imageHtml + '<br><br>' : imageHtml;
