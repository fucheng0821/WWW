...
// 自动检测状态字段名
function detect_status_field($db) {
    try {
...
$status_field = detect_status_field($db);
$seo_prefix = detect_seo_prefix($db);
...
<body>
    <div class="container">
        ...
        <div class="diagnosis-info">
            <h4>🔍 数据库诊断信息</h4>
            <p><strong>状态字段：</strong><code><?php echo $status_field; ?></code></p>
            <p><strong>SEO字段前缀：</strong><code><?php echo $seo_prefix; ?></code></p>
        </div>
        ...
        <div style="text-align: center; margin: 30px 0;">
            ...
            <a href="database_diagnose.php" class="layui-btn layui-btn-primary layui-btn-lg">🔍 数据库诊断</a>
