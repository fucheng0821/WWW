...
-- 表数据: admin_users
INSERT INTO `admin_users` VALUES ('1', 'admin', '$2y$10$vDTrzdd66Zt4QXCLaPC1pOzVcxFGGGpx2isxW.QIENa8LcW5acwr6', 'admin@example.com', '1', '2025-09-25 10:16:39', '2025-09-25 10:16:39');
...
-- 表数据: admins
INSERT INTO `admins` VALUES ('1', 'admin', '$2y$10$VNU828Plna.P5fEC0bfhr.Z/EJMo2nHIxdb.cMzR60CICAFCcrO0C', '372058464@QQ.COM', '超级管理员', 'admin', '2025-09-26 22:00:13', '1', '2025-09-01 18:16:41', '2025-09-26 22:00:13');
...
-- 表数据: categories
INSERT INTO `categories` VALUES ('1', '首页', 'home', '网站首页', NULL, 'content', NULL, '0', '1', '0', '', '', '', '2025-09-06 21:28:53', '2025-09-26 16:24:21', '7');
...
INSERT INTO `categories` VALUES ('6', '联系我们', 'contact', '', '<p>1234567</p>', 'content', NULL, '0', '6', '1', '', '', '', '2025-09-06 21:28:53', '2025-09-26 16:27:57', '8');
...
CREATE TABLE `contents` (
  ...
  KEY `sort_order` (`sort_order`)
) ENGINE=InnoDB AUTO_INCREMENT=369 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='内容表';
...
INSERT INTO `contents` VALUES ('291', '4', '吼吼吼吼吼', 'K8asffQK', '', '<p>开始编写您的内容...</p>', NULL, NULL, NULL, '', '23', '0', '0', '1', '2025-09-07 07:25:15', '', '', '', '2025-09-07 07:25:15', '2025-09-26 10:30:50');
INSERT INTO `contents` VALUES ('292', '4', '1111111', '1111111', '', '<p>开始编写您的内容...<img src=\"http://gaoguangshike.cn/uploads/images/68bcc3601149a_1757201248.jpg\"></p>', '/uploads/images/68be8c881cd50_1757318280.png', NULL, NULL, '', '45', '0', '1', '1', '2025-09-07 07:27:31', '', '', '', '2025-09-07 07:27:31', '2025-09-26 16:16:13');
...
INSERT INTO `contents` VALUES ('296', '5', '开源工具 DaVinci Resolve 新增实时 8K HDR 编辑功能，降低高端制作门槛', '4', '', 'Blackmagic Design 宣布为旗下免费视频剪辑与调色软件 DaVinci Resolve 推送 19.1 版本，首次支持实时 8K HDR 素材编辑。此前 8K 剪辑需依赖高端工作站，而新版本通过优化 GPU 渲染算法，在搭载中端显卡（如 RTX 4060）的设备上即可流畅处理 8K/60fps HDR 素材，同时内置 10 组新的 HDR 预设模板，覆盖电影、纪录片、广告等不同场景。该更新让独立创作者无需高额硬件投入，也能涉足高端视频制作领域。', '/uploads/images/68c000baef50e_1757413562.png', NULL, NULL, '', '2', '0', '0', '1', '2025-09-08 23:14:45', '', '', '', '2025-09-08 23:14:45', '2025-09-24 19:50:34');
INSERT INTO `contents` VALUES ('297', '5', '短视频平台推出 “竖屏电影” 扶持计划，推动视频制作形态创新', '5', '', '某头部短视频平台于本月启动 “竖屏电影创作扶持计划”，面向创作者开放专项资金与流量资源。计划明确支持 1-5 分钟的竖屏叙事类视频，要求作品具备完整剧情结构与电影级制作水准，平台将为入选项目提供从脚本审核、拍摄设备租赁到后期调色的全流程支持。首批签约的 12 部作品中，已有 3 部通过 “竖屏分镜优化”“特写镜头强化” 等适配设计，实现单条播放量破 5000 万，推动竖屏视频从 “碎片化娱乐” 向 “精品化叙事” 转型。', '/uploads/images/68c000a46e2f6_1757413540.png', NULL, NULL, '', '4', '0', '0', '1', '2025-09-08 23:15:04', '', '', '', '2025-09-08 23:15:04', '2025-09-25 23:41:55');
...
这个案例表明，专业的商业摄影不仅是技术展示，更是品牌战略的重要执行工具，能够有效推动品牌形象升级和市场定位重构。', 'http://gaoguangshike.cn/uploads/images/thumb_68c9f9f97e791_1758067193.png?v=1758067193', NULL, NULL, '', '9', '0', '1', '1', '2025-09-16 14:18:58', '高端餐饮品牌形象重塑案例-御膳坊商业摄影成功实践', '商业摄影案例,餐饮品牌摄影,品牌形象重塑,美食摄影,视觉营销', '御膳坊高端中餐厅通过专业商业摄影实现品牌形象重塑，社交媒体互动率提升240%，客单价提高15%。详细解析餐饮摄影策划、拍摄执行和后期制作全流程。', '2025-09-16 14:18:58', '2025-09-26 14:45:15');
...
新征程已经开启，让我们携手共进，再创辉煌！', '/uploads/images/video_thumbnail_1758185047_5a45e4c9.jpg', NULL, NULL, '', '1', '0', '1', '1', '2025-09-18 16:44:17', '', '', '', '2025-09-18 16:44:17', '2025-09-26 10:03:09');
...
#### 结语
酒类广告是一门艺术，也是科学与文化的结合。从传统媒体到数字时代，酒类广告不断演变，既反映了社会的变化，也塑造了消费者的选择。未来，随着技术的发展和消费者价值观的多元化，酒类广告将继续创新，在传递品牌故事的同时，承担起更多的社会责任。', '/uploads/images/video_thumbnail_1758186995_ba018b4f.jpg', NULL, NULL, '', '2', '0', '1', '1', '2025-09-18 17:08:09', '', '', '', '2025-09-18 17:08:09', '2025-09-26 10:03:43');
...
<div style=\"text-align: justify;\"></div>', 'http://gaoguangshike.cn/uploads/images/thumb_68cea73d6b299_1758373693.jpg?v=1758373693', NULL, NULL, '', '3', '0', '0', '1', '2025-09-20 21:09:11', '平面设计注意事项：排版、色彩、字体等关键要点', '平面设计要点,设计排版技巧,色彩搭配原则,字体选择指南,设计一致性', '了解平面设计的关键注意事项，包括排版布局、色彩心理学、字体选择、图像处理和设计一致性。掌握专业设计原则，提升作品质量和视觉效果。', '2025-09-20 21:09:11', '2025-09-24 19:50:42');
...
<div><img src=\"http://gaoguangshike.cn/uploads/images/68ced2bf2b4e9_1758384831.png?v=1758384831\" style=\"margin-right: 0px; margin-left: 0px;\"></div>', 'http://gaoguangshike.cn/uploads/images/thumb_68ced2f6bff6d_1758384886.png?v=1758384886', NULL, NULL, '', '7', '0', '0', '1', '2025-09-21 00:14:09', '短视频制作5大关键点，轻松获取更多流量 | 实用技巧', '短视频制作,获取流量,视频优化,短视频技巧,内容创作', '掌握短视频制作的5个关键技巧：黄金3秒开头、优质内容、视听体验优化、标题封面设计、互动引导。帮助你的视频获得更多流量和关注，提升曝光率。', '2025-09-21 00:14:09', '2025-09-26 16:02:09');
INSERT INTO `contents` VALUES ('368', '16', '现代网站制作需要注意什么', 'vyf1ys02', '', '<img src=\"http://gaoguangshike.cn/uploads/images/68d636f94c10f_1758869241.png?v=1758869241\" style=\"margin-right: 0px; margin-left: 0px;\">现代网站制作需要注意什么

随着互联网技术的飞速发展，现代网站制作已经不再仅仅局限于简单的页面设计和功能实现，而是需要综合考虑用户体验、技术实现、性能优化、安全性和可维护性等多个方面。无论是企业官网、电商平台还是个人博客，一个成功的网站都需要在多个维度上做到精益求精。以下是现代网站制作中需要注意的几个关键点：

<br>1. **响应式设计**
现代用户通过多种设备访问网站，包括桌面电脑、平板、手机等。因此，响应式设计（Responsive Design）已成为网站制作的基本要求。通过使用弹性布局（Flexbox）、网格布局（CSS Grid）和媒体查询（Media Queries），确保网站在不同屏幕尺寸和设备上都能提供一致且流畅的用户体验。

<br>2. **用户体验（UX）与用户界面（UI）设计**
用户体验是决定用户是否愿意停留并继续使用网站的关键因素。在设计过程中，需要关注以下几点：
- **直观的导航**：确保用户能够轻松找到所需信息，菜单结构清晰，页面层级不宜过深。
- **页面加载速度**：用户对网站加载时间的容忍度极低，优化图片、压缩代码和使用缓存技术可以显著提升速度。
- **视觉设计**：简洁、美观的界面设计能够增强用户的信任感和使用欲望。同时，配色、字体和图标需要保持一致性，以强化品牌形象。

<br>3. **搜索引擎优化（SEO）**
网站在设计之初就需要考虑SEO，以提高在搜索引擎中的排名，吸引更多自然流量。关键点包括：
- **语义化HTML**：使用正确的HTML标签（如``、``、``等）有助于搜索引擎理解页面内容。
- **优化元标签**：精心设计标题（Title）、描述（Description）和关键词（Keywords）。
- **内部链接结构**：合理的内部链接可以提升页面权重，并帮助用户和爬虫发现更多内容。

<br>4. **性能优化**
网站性能直接影响用户体验和SEO表现。优化措施包括：
- **压缩资源**：通过工具（如Webpack、Gulp）压缩CSS、JavaScript和HTML文件。
- **图片优化**：使用WebP等现代格式，并借助懒加载（Lazy Loading）技术减少初始加载时间。
- **内容分发网络（CDN）**：通过CDN加速静态资源的加载，尤其对全球用户访问的网站尤为重要。

<br>5. **安全性**
网络安全威胁日益增多，保护用户数据和网站本身的安全至关重要：
- **HTTPS加密**：通过SSL证书确保数据传输的安全性。
- **防止常见攻击**：如SQL注入、跨站脚本（XSS）和跨站请求伪造（CSRF）等，需要在代码层面加以防范。
- **定期更新**：保持CMS、插件和依赖库的最新版本，以修复已知漏洞。

<br>6. **可访问性（Accessibility）**
网站应当对所有用户友好，包括残障人士。遵循Web内容可访问性指南（WCAG）可以提高网站的包容性：
- **键盘导航**：确保网站可以通过键盘完全操作。
- **屏幕阅读器兼容**：为图片添加alt文本，使用ARIA属性增强语义。
- **颜色对比度**：确保文本与背景有足够的对比度，方便色弱用户阅读。

<br>7. **可维护性与扩展性**
网站上线后可能需要频繁更新和功能扩展，因此代码结构和架构设计需要具备良好的可维护性：
- **模块化开发**：使用组件化思维（如React、Vue等框架）编写可复用的代码。
- **清晰的文档**：为代码和功能编写详细的文档，方便团队协作和后续维护。
- **版本控制**：使用Git等工具管理代码变更，确保开发过程有序且可追溯。

<br>8. **数据分析与迭代**
网站上线后，通过工具（如Google Analytics）收集用户行为数据，分析访问量、跳出率、转化率等指标，并根据数据反馈不断优化网站内容和功能。

<br>结语
现代网站制作是一个综合性的工程，涉及设计、开发、运维等多个环节。只有全面考虑响应式设计、用户体验、SEO、性能、安全性和可维护性等方面，才能打造出既美观又高效、安全且易用的网站。随着技术的不断演进，网站制作者也需要持续学习新工具和最佳实践，以适应快速变化的互联网环境。<div><br></div>', 'http://gaoguangshike.cn/uploads/images/thumb_68d6371157bdf_1758869265.png?v=1758869265', NULL, NULL, '', '2', '0', '0', '1', '2025-09-26 14:47:49', '现代网站制作指南：响应式设计、SEO与性能优化', '网站制作,响应式设计,SEO优化,用户体验,网站安全', '了解现代网站制作的关键要素：响应式设计、用户体验优化、SEO策略、性能提升及安全保障。打造高效、安全且用户友好的网站。', '2025-09-26 14:47:49', '2025-09-26 14:48:09');
...
CREATE TABLE `platform_configs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `platform_key` varchar(50) NOT NULL COMMENT '平台唯一标识',
  `platform_name` varchar(100) NOT NULL COMMENT '平台名称',
  `config_data` text NOT NULL COMMENT '平台配置数据(JSON格式)',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '状态(0=禁用,1=启用)',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `platform_key` (`platform_key`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COMMENT='外部发布平台配置表';

-- 表数据: platform_configs
INSERT INTO `platform_configs` VALUES ('1', 'wechat', '微信公众号', '{\"app_id\": \"\", \"app_secret\": \"\", \"token\": \"\", \"encoding_aes_key\": \"\", \"api_url\": \"https://api.weixin.qq.com\", \"auto_reply\": false, \"reply_template\": \"感谢关注！我们会持续为您提供优质内容。\"}', '1', '2025-09-24 00:18:32', '2025-09-24 00:18:32');
INSERT INTO `platform_configs` VALUES ('2', 'weibo', '新浪微博', '{\"app_key\": \"\", \"app_secret\": \"\", \"access_token\": \"\", \"api_url\": \"https://api.weibo.com\", \"auto_hashtags\": false, \"default_hashtags\": [\"科技\", \"生活\"]}', '1', '2025-09-24 00:18:32', '2025-09-24 00:18:32');
INSERT INTO `platform_configs` VALUES ('3', 'toutiao', '今日头条', '{\"client_key\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://open.snssdk.com\", \"category\": \"科技\", \"auto_tags\": true}', '1', '2025-09-24 00:18:32', '2025-09-24 00:27:20');
INSERT INTO `platform_configs` VALUES ('4', 'douban', '豆瓣', '{\"api_key\": \"\", \"api_secret\": \"\", \"access_token\": \"\", \"api_url\": \"https://api.douban.com\", \"group_id\": \"\", \"allow_comment\": true}', '1', '2025-09-24 00:18:32', '2025-09-24 00:18:32');
INSERT INTO `platform_configs` VALUES ('5', 'douyin', '抖音', '{\"api_key\": \"\", \"api_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://open.douyin.com\", \"auto_publish\": true}', '1', '2025-09-24 00:27:20', '2025-09-24 00:27:20');
INSERT INTO `platform_configs` VALUES ('6', 'kuaishou', '快手', '{\"client_key\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://open.kuaishou.com\", \"auto_publish\": true}', '1', '2025-09-24 00:27:20', '2025-09-24 00:27:20');
INSERT INTO `platform_configs` VALUES ('7', 'xiaohongshu', '小红书', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://open.xiaohongshu.com\", \"auto_publish\": true}', '1', '2025-09-24 00:27:20', '2025-09-24 00:27:20');
INSERT INTO `platform_configs` VALUES ('10', 'baidu', '百家号', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://baijiahao.baidu.com\", \"auto_publish\": true}', '1', '2025-09-24 00:27:20', '2025-09-24 00:27:20');
INSERT INTO `platform_configs` VALUES ('11', 'zhihu', '知乎', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://open.zhihu.com\", \"auto_publish\": true}', '1', '2025-09-24 00:27:20', '2025-09-24 00:27:20');
INSERT INTO `platform_configs` VALUES ('12', 'bilibili', 'B站', '{\"app_key\": \"\", \"app_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://api.bilibili.com\", \"auto_publish\": true}', '1', '2025-09-24 00:27:20', '2025-09-24 00:27:20');
INSERT INTO `platform_configs` VALUES ('15', 'kuaikan', '快看漫画', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://api.kuaikanmanhua.com\", \"auto_publish\": true}', '1', '2025-09-24 00:29:58', '2025-09-24 00:29:58');
INSERT INTO `platform_configs` VALUES ('16', 'yilan', '一览', '{\"api_key\":\"\",\"api_secret\":\"\",\"access_token\":\"\",\"refresh_token\":\"\",\"status\":1,\"config\":{\"publish_type\":\"auto\",\"title_template\":\"\",\"content_template\":\"\"}}', '1', '2025-09-24 00:29:58', '2025-09-24 01:10:19');
INSERT INTO `platform_configs` VALUES ('17', 'dayu', '大鱼号', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://dayu.uc.cn\", \"auto_publish\": true}', '1', '2025-09-24 00:29:58', '2025-09-24 00:29:58');
INSERT INTO `platform_configs` VALUES ('18', 'chyxx', '创头条', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://ct.ttnia.com\", \"auto_publish\": true}', '1', '2025-09-24 00:29:58', '2025-09-24 00:29:58');
INSERT INTO `platform_configs` VALUES ('19', 'maoyan', '猫眼娱乐', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://mt.meituan.com\", \"auto_publish\": true}', '1', '2025-09-24 00:29:58', '2025-09-24 00:29:58');
INSERT INTO `platform_configs` VALUES ('20', 'alizhizhen', '阿里知站', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://zhizhan.alibaba.com\", \"auto_publish\": true}', '1', '2025-09-24 00:29:58', '2025-09-24 00:29:58');
INSERT INTO `platform_configs` VALUES ('21', 'pengpai', '澎湃新闻', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://api.thepaper.cn\", \"auto_publish\": true}', '1', '2025-09-24 00:29:58', '2025-09-24 00:29:58');
INSERT INTO `platform_configs` VALUES ('22', 'huxiu', '虎嗅网', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://api.huxiu.com\", \"auto_publish\": true}', '1', '2025-09-24 00:29:58', '2025-09-24 00:29:58');
INSERT INTO `platform_configs` VALUES ('23', 'iyiou', '亿欧网', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://api.iyiou.com\", \"auto_publish\": true}', '1', '2025-09-24 00:29:58', '2025-09-24 00:29:58');
INSERT INTO `platform_configs` VALUES ('24', 'tmtpost', '钛媒体', '{\"client_id\": \"\", \"client_secret\": \"\", \"access_token\": \"\", \"refresh_token\": \"\", \"api_url\": \"https://api.tmtpost.com\", \"auto_publish\": true}', '1', '2025-09-24 00:29:58', '2025-09-24 00:29:58');

-- 表结构: platform_publish_records
DROP TABLE IF EXISTS `platform_publish_records`;
CREATE TABLE `platform_publish_records` (
  ...
  `platforms` text NOT NULL COMMENT '发布的平台列表(JSON格式)',
  `publish_type` varchar(20) NOT NULL DEFAULT 'normal' COMMENT '发布类型(normal=普通,draft=草稿,scheduled=定时)',
  `scheduled_time` datetime DEFAULT NULL COMMENT '定时发布时间',
  `status` varchar(20) NOT NULL DEFAULT 'pending' COMMENT '发布状态(pending=待发布,success=成功,partial=部分成功,failed=失败)',
  `results` text COMMENT '发布结果详情(JSON格式)',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  ...
  KEY `status` (`status`),
  KEY `created_at` (`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='内容发布到外部平台记录表';
...
CREATE TABLE `uploads` (
  ...
  KEY `created_at` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=295 DEFAULT CHARSET=utf8mb4 COMMENT='文件上传记录表';
...
INSERT INTO `uploads` VALUES ('293', '68d636f94c10f_1758869241.png', '根据关键词生成图片 (24).png', '../../../uploads/images/68d636f94c10f_1758869241.png', 'uploads/images/68d636f94c10f_1758869241.png?v=1758869241', 'png', '786593', '1', '2025-09-26 14:47:21');
INSERT INTO `uploads` VALUES ('294', '68d6371157bdf_1758869265.png', '根据关键词生成图片 (24).png', '../../../uploads/images/68d6371157bdf_1758869265.png', 'uploads/images/68d6371157bdf_1758869265.png?v=1758869265', 'png', '786593', '1', '2025-09-26 14:47:45');
